...
**Tweet @ Me** is an android app that allows a user to view their Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/neysapatel/Twitter/blob/master/Tweet%20Me.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
